    ...
    <div className="home">
      <div className="home-upper">
        ...
        >
          ...
          I love all things TypeScript, React {"&"} Node with Express.
        </motion.h5>
        <motion.p
          className="location"
          initial={{ opacity: 0 }}
      ...
      <div id="home-lower" className="home-lower">
        ...
        <div className="all-projects">
          ...
          <ProjectBox
            title={"Cool App"}
            secondTitle={"Very cool App in the making"}
            link1={"https://google.com"}
            link2={"https://google.com"}
          />
          <ProjectBox
            title={"BeeShort"}
            secondTitle={"Full Stack Link Shortener"}
            link1={"https://google.com"}
            link2={"https://beeshort.link"}
          />
        </div>
      </div>
    </div>
